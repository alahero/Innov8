...
**Project:** Innov8 Creations
**Generated:** 2026-03-03 20:37:08
...
|------|-----|--------------|
| Primary | `#0A1F44` | `--color-primary` |
| Secondary | `#FF2D2D` | `--color-secondary` |
| CTA/Accent | `#00B4FF` | `--color-cta` |
| Background | `#FFFFFF` | `--color-background` |
| Text | `#0A1F44` | `--color-text` |

**Color Notes:** Navy for trust, Red for energy (USA), Cyan for technology.

### Typography

- **Heading Font:** Montserrat
- **Body Font:** Inter
- **Mood:** National Reach, Local Dedication, Result-Driven, Modern, Premium
- **Google Fonts:** [Montserrat + Inter](https://fonts.google.com/share?selection.family=Montserrat:wght@700;800;900|Inter:wght@300;400;500;600)
