        ...
        <div class="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-8 h-auto md:h-[1200px]">
            ...
            <div class="md:col-span-4 md:row-span-1 group relative overflow-hidden rounded-[3rem] bg-brand-surface shadow-2xl cursor-pointer"
                ...
                <div class="absolute bottom-12 left-12">
                    <p class="text-[10px] font-black uppercase tracking-[0.4em] text-brand-cyan mb-4">Branding / Fintech
                    </p>
                    <h4 class="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4">CRAFTING SKY DEFI</h4>
                    <p class="text-sm text-white/50 max-w-sm font-medium">Increasing conversion by 40% through cinematic
                        identity design.</p>
                </div>
            </div>
            ...
            <div class="md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-[3rem] bg-brand-surface cursor-pointer"
                ...
                <div
                    ...
                    <p class="text-[10px] font-black uppercase tracking-[0.4em] text-cyan-400 mb-2">UI/UX / Mobile</p>
                    <h4 class="text-2xl font-black uppercase tracking-tighter">SNAPCHAT AR</h4>
                </div>
            </div>
            ...
            <div class="md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-[3rem] bg-brand-surface cursor-pointer"
                ...
                <div class="absolute bottom-12 left-12">
                    ...
                    <h4 class="text-2xl font-black uppercase tracking-tighter">VANTARA EXPERIENCE</h4>
                </div>
            </div>
            ...
            <div class="md:col-span-4 md:row-span-1 group relative overflow-hidden rounded-[3rem] bg-brand-surface cursor-pointer shadow-2xl"
                ...
                <div
                    ...
                    <p class="text-[10px] font-black uppercase tracking-[0.4em] text-brand-cyan mb-4">SaaS / Enterprise
                    </p>
                    <h4 class="text-4xl font-black uppercase tracking-tighter mb-4">STRIPE CONNECT</h4>
                    <p class="text-sm text-white/50 max-w-lg font-medium">B2B dashboard redesign for $100M+ volume
                        transactions.</p>
                </div>
            </div>
